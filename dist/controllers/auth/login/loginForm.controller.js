...
var loginForm = function (req, res, next) { return __awaiter(void 0, void 0, void 0, function () {
    var _a, email, password, prisma, user, isPasswordValid, token, error_1;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                return [4 /*yield*/, (0, bcrypt_1.comparePasswords)(password, user.password)];
            case 2:
            ...
            case 3:
                error_1 = _b.sent();
                next(error_1); // Pass error to centralized error handler
                return [3 /*break*/, 4];
